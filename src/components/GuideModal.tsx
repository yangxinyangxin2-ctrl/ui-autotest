...
export function GuideModal() {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-violet-950/80 backdrop-blur-sm p-4">
            <div className="bg-[#4c1d95] rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden transform transition-all duration-300 border border-zinc-800">
                <div className="bg-[#5b21b6] p-8 text-white text-center relative overflow-hidden">
                ...
                <div className="p-6 sm:p-8 space-y-6 text-zinc-400 bg-[#4c1d95]">
                ...
                <div className="p-6 bg-[#5b21b6] border-t border-zinc-800 text-center">
                    <button 
